...
export const IPC = {
  ...
  /** Renderer asks main to show/focus the NATIVE desktop settings panel
   * (main-owned, drawn outside the renderer as its own web contents laid over
   * it inside the wallet window). No argument, no return data;
